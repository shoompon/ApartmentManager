                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
							<!-- ย้ายออก: <small> ค้นหาการเข้าพัก</small> -->รายงานการเข้าพักและการจอง</h1>
						
						
						<table class="table table-hover">
							<thead>
								<tr>
									<th class="col-md-2 text-center">ชื่อ-สกุล</th>
									<th class="col-md-2">จำนวนห้องจอง</th>
									<th class="col-md-2">จำนวนห้องพัก</th>					
								</tr>
							</thead>
						<tbody>
							<tr>
								<td class="text-center">นายสมเกียรติ &nbsp;ทองมี</td>
								<td>1</td>
								<td>1</td>
							</tr>
							<tr>
								<td class="text-center">นางวิภา &nbsp;แม่กิมเฮง</td>
								<td>2</td>
								<td>2</td>
							</tr>
							<tr>
								<td  class="text-center">นางสาวฤดี &nbsp;ทองทวี</td>
								<td>3</td>
								<td>2</td>
