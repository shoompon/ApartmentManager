                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
							ย้ายเข้า: <small> แสดงรายละเอียดห้องพัก</small>
                        </h1>
						
						<!-- Menu Tab -->
						<ul class="nav nav-tabs">
							<li><a href="#">1.ค้นหาการจอง</a></li>
							<li><a href="#">2. บันทึกข้อมูลลูกค้า</a></li>
							<li class="active"><a href="#">3. แสดงรายละเอียดห้องพัก</a></li>
						...
						<div class="container-fluid">
							<form class="form-horizontal" role="form">
								<td><a href="checkin_02.php" class="btn btn-primary btn-md" role="button">ย้อนกลับ</a></td>
								<td><a href="checkin_04.php" class="btn btn-primary btn-md pull-right" role="button">ถัดไป</a></td>	
							</form>
						</div>
