            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
					...
					<li>
                        ...
                        <a href="javascript:;" data-toggle="collapse" data-target="#idBooking"><i class="fa fa-fw fa-calendar"></i> จองห้องพัก <i class="fa fa-fw fa-caret-down"></i></a>
                        <ul id="idBooking" class="collapse">
                            <li>
                                <a href="#">ค้นหาข้อมูลลูกค้า</a>
                            </li>
                            <!-- <li>
                                <a href="#">เพิ่มข้อมูลลูกค้า</a>
                            </li> -->
							<li>
                                <a href="#">ค้าหาห้องว่าง</a>
                            </li>
                        </ul>
                    </li>
                   <!--  <li>
                        <a href="charts.html"><i class="fa fa-fw fa-bar-chart-o"></i> ย้ายเข้า </a>
                    </li> -->
					<li>
                        <a href="javascript:;" data-toggle="collapse" data-target="#idCheckin"><i class="fa fa-fw fa-plus-square"></i> ย้ายเข้า <i class="fa fa-fw fa-caret-down"></i></a>
                        <ul id="idCheckin" class="collapse">
                            <li>
                                <a href="#">สร้างข้อมูลการเข้าอยู่</a>
                            </li>
                            <li>
                                <a href="#">พิมพ์ใบเสร็จย้ายเข้า</a>
                            </li>
							<li>
                                <a href="#">พิมพ์สัญญา</a>
                            </li>
                    ...
                    <li>
                        <a href="tables.html"><i class="fa fa-fw fa-plus-square"></i> ย้ายเข้า (จองมาก่อน)</a>
                    </li>
					<li>
					...
					<li>
                        <a href="javascript:;" data-toggle="collapse" data-target="#idCheckOut"><i class="fa fa-fw fa-remove"></i> ย้ายออก <i class="fa fa-fw fa-caret-down"></i></a>
                        <ul id="idCheckOut" class="collapse">
                            <li>
                                <a href="#">พิมพ์ใบเสร็จย้ายออก</a>
                            </li>
                        </ul>
                    </li>
                    <li>
                        <a href="bootstrap-grid.html"><i class="fa fa-fw fa-eur"></i> บันทึกรายรับ</a>
                    </li>
					<li>
                        <a href="bootstrap-grid.html"><i class="fa fa-fw fa-eur"></i> บันทึกรายจ่าย</a>
                    </li>
					<li>
                ...
                <div class="row">
                    <div class="col-lg-12">
						...
						<div class="form-group">
							<label for="usr">รหัสการจอง:</label>
							<input type="text" class="form-control" id="usr">
						</div>
						<div class="form-group">
							<label for="pwd">ชื่อลูกค้า:</label>
